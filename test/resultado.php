...
<body class="resultado-body">
    ...
    <div class="resultado-container">
                ...
                <?php foreach ($plantas as $planta): ?>
                    <div class="producto-card">
                        <div class="producto-img">
                            <!-- Accedemos a la imagen subiendo un nivel desde la carpeta test -->
        ...
        <div class="resultado-navegacion">
            <!-- Volver a repetir el test dentro de la carpeta test -->
            <a href="test.html" class="btn-nav btn-volver">← Repetir Test</a>
            <!-- Navegar al catálogo en la raíz -->
            <a href="../catalogo.php" class="btn-nav btn-catalogo">Ver Todas las Plantas →</a>
            <!-- Volver al inicio en la raíz -->
